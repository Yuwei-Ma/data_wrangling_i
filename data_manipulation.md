...
filter out missing wows with `drop_na()` Drop rows containing missing
values
...
PD walk less than 11 and sex 2 Solution
...
```
    ...
    ##    <chr>         <dbl>   <dbl>   <dbl>    <dbl>   <dbl>
    ##  1 #85               2       4      13        6      11
    ##  2 #1/2/95/2         2       4      13        7       9
    ##  3 #1/2/95/2         2       4      13        7      10
    ##  4 #1/2/95/2         2       5      13        8      10
    ##  5 #1/2/95/2         2       5      13        8      10
    ##  6 #1/2/95/2         2       5      13        6      10
    ##  7 #5/5/3/83/3-3     2       5      13        8      10
    ##  8 #5/5/3/83/3-3     2       5      14        7      10
    ##  9 #5/5/3/83/3-3     2       5      14        8      10
...
other bad ways: nesting things together

Use pipes to avoid all this

``` r
litters_df = 
  read_csv("data/FAS_litters.csv", na = c("NA",".","")) |> # command+shift+m - pipe operator hot-key
  janitor::clean_names() |> 
...
variable that indicates whether PD pivot is 7 or more days Solution
